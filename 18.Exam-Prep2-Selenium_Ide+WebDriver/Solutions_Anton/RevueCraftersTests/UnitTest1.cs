...
namespace RevueCraftersTests
{
    public class Tests
    {
        ...
        public void Setup()
        {
            // start Chrome BrowserMaximized
            //disable search engine choice screen on start
            ...
            driver.FindElement(By.Id("form3Example3")).SendKeys("revue2@revue.com");
            driver.FindElement(By.Id("form3Example4")).SendKeys("ExamPrepEx2");
